 ...
 * Used by AllProducts, ProductDetail, ProductsByRegion, Homepage, etc.
 */
...
export const productsData = [
  // ===== MIỀN NAM =====
  {
    ...
    rating: 4.8,
    reviewCount: 124,
    description: "Thanh long ruột đỏ Bình Thuận được trồng theo tiêu chuẩn GLOBALGAP, quả to đều, ruột đỏ đậm, vị ngọt thanh đặc trưng. Không sử dụng thuốc bảo vệ thực vật hóa học.",
    nutritionInfo: "Giàu vitamin C, chất xơ, chất chống oxy hóa. Hỗ trợ tiêu hóa và tăng cường miễn dịch.",
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 89,
    description: "Xoài Cát Hòa Lộc nổi tiếng với vị ngọt lịm, thịt dày, ít xơ. Được trồng tại vùng đất phù sa Tiền Giang, chất lượng hàng đầu Việt Nam.",
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 67,
    description: "Bưởi da xanh Bến Tre tép mọng nước, vị ngọt thanh, không hạt. Là đặc sản truyền thống của xứ dừa.",
    nutritionInfo: "Giàu vitamin C, folate. Hỗ trợ giảm cân và tăng cường sức đề kháng.",
    certifications: ["Organic", "VIETGAP"],
    seller: { name: "Nhà vườn Sông Tiền", avatar: "ST", rating: 4.7, totalContracts: 35 },
    commitments: [
      "100% bưởi hữu cơ",
  ...
  // ===== MIỀN TRUNG =====
  {
    ...
    rating: 4.9,
    reviewCount: 156,
    description: "Cà phê Robusta loại 1 từ vùng đất đỏ bazan Đắk Lắk. Hạt đều, rang lên thơm nồng, vị đắng đậm đặc trưng Tây Nguyên.",
    nutritionInfo: "Chứa caffeine tự nhiên, chất chống oxy hóa. Tăng cường tỉnh táo và tập trung.",
    certifications: ["UTZ", "Rainforest Alliance"],
    seller: { name: "Farm H'Hen Niê", avatar: "HN", rating: 4.9, totalContracts: 62 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 45,
    description: "Ớt chuông được trồng trong nhà kính tại Đà Lạt, quả to, giòn, nhiều màu sắc. Đạt tiêu chuẩn xuất khẩu sang EU.",
    nutritionInfo: "Cực giàu vitamin C (gấp 3 lần cam), vitamin A, chất xơ.",
    certifications: ["VIETGAP"],
    seller: { name: "Đà Lạt Fresh Farm", avatar: "DF", rating: 4.6, totalContracts: 28 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 78,
    description: "Hạt tiêu đen Gia Lai - vùng đất bazan nổi tiếng. Hạt chắc, đều, thơm nồng, vị cay mạnh đặc trưng. Là nguyên liệu yêu thích của đầu bếp.",
    nutritionInfo: "Chứa piperine hỗ trợ tiêu hóa, kháng viêm, chống oxy hóa.",
    certifications: ["Organic"],
    seller: { name: "Nông Trường Chư Sê", avatar: "CS", rating: 4.8, totalContracts: 31 },
    commitments: [
      "Hạt tiêu 100% hữu cơ",
  ...
  // ===== MIỀN BẮC =====
  {
    ...
    rating: 4.9,
    reviewCount: 203,
    description: "Gạo ST25 đạt giải Gạo ngon nhất thế giới. Hạt dài, thơm tự nhiên, cơm mềm dẻo, vị ngọt hậu. Sản xuất tại Sóc Trăng.",
    nutritionInfo: "Giàu tinh bột, vitamin B1, sắt. Nguồn năng lượng chính cho bữa ăn.",
    certifications: ["VIETGAP", "World's Best Rice"],
    seller: { name: "HTX Lúa Vàng", avatar: "LV", rating: 4.7, totalContracts: 38 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 91,
    description: "Chè Tân Cương - Thái Nguyên, đệ nhất danh trà Việt Nam. Búp chè non, sao suốt bằng tay, nước xanh trong, vị chát ngọt hậu tự nhiên.",
    nutritionInfo: "Giàu catechin, polyphenol, theanine. Tốt cho tim mạch, chống lão hóa.",
    certifications: ["Organic", "Geographical Indication"],
    seller: { name: "HTX Chè Tân Cương", avatar: "TC", rating: 4.8, totalContracts: 40 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 56,
    description: "Cam Vinh Nghệ An nổi tiếng với vị ngọt đậm, mọng nước, vỏ mỏng. Trồng trên đất đồi pha cát đặc trưng xứ Nghệ.",
    nutritionInfo: "Giàu vitamin C, hesperidin, chất xơ. Tăng cường miễn dịch mùa đông.",
    certifications: ["VIETGAP"],
    seller: { name: "HTX Cam Vinh", avatar: "CV", rating: 4.6, totalContracts: 25 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 112,
    description: "Vải thiều Lục Ngạn - thương hiệu nông sản nổi tiếng cả nước. Quả to, cùi dày, hạt nhỏ, vị ngọt thanh, thơm nức.",
    nutritionInfo: "Giàu vitamin C, polyphenol, đồng. Bổ máu, tăng cường sức khỏe.",
    certifications: ["GLOBALGAP", "Geographical Indication"],
    seller: { name: "HTX Vải Hồng Giang", avatar: "HG", rating: 4.7, totalContracts: 55 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 38,
    description: "Rau sạch trồng trong nhà kính tại Đà Lạt: xà lách, cải thìa, cà chua bi. Tươi ngon, an toàn, giao hàng mỗi sáng.",
    nutritionInfo: "Đa dạng vitamin và khoáng chất, chất xơ cao. Tốt cho sức khỏe hàng ngày.",
    certifications: ["VIETGAP"],
    seller: { name: "Đà Lạt Fresh Farm", avatar: "DF", rating: 4.6, totalContracts: 28 },
    commitments: [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 67,
    description: "Arabica Sơn La trồng ở độ cao 1200m, khí hậu mát lạnh tạo nên hương vị phức tạp: hoa quả, chocolate, hậu vị dài. SCA Score 84+.",
    nutritionInfo: "Caffeine vừa phải, giàu chất chống oxy hóa, chlorogenic acid.",
    certifications: ["SCA Score 84+", "Organic"],
    seller: { name: "HTX Cà Phê Sơn La", avatar: "SL", rating: 4.9, totalContracts: 18 },
    commitments: [
...
export const getProductById = (id) => productsData.find(p => p.id === Number(id));

// Helper: get products by region
export const getProductsByRegion = (region) => productsData.filter(p => p.region === region);

// Helper: get similar products (same region or category, exclude self)
export const getSimilarProducts = (product, limit = 4) => {
  return productsData
    .filter(p => p.id !== product.id && (p.region === product.region || p.category === product.category))
    .slice(0, limit);
};
